...
type AccountNetworkData = Record<string, any>;
...
type KeyRegistrationPayload = Parameters<
  typeof algosdk.makeKeyRegistrationTxnWithSuggestedParamsFromObject
>[0] & { stakingRegistration?: boolean };
...
const searchForTransactionsAction = (payload: { addr: string }) =>
