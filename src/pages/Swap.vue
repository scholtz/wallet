...
export default {
  ...
  methods: {
    ...
    async clickGetQuote() {
      ...
      const request = `https://app.alammex.com/api/quote?chain=${chain}&fromASAID=${fromAsset}&toASAID=${toAsset}&atomicOnly=false&amount=${amount}&type=fixed-input&disabledProtocols=&referrerAddress=WWKG5VDFTW5I74KALGKDKTLRH2QBSZQLA5YYSKBVZYVID23BGHCKL474IE`;
