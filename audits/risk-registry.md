...
| Field                                  | Value                                           |
| -------------------------------------- | ----------------------------------------------- |
| Last updated by audit report           | `audits/reports/2026-08-22-071d4f6-github-copilot.md` |
| Last updated (audited commit)          | `071d4f63c87bd96cbbd7a148d8c7d1004c1e90b9`     |
| Last updated (commit date)             | `2026-08-22`                                    |
...
- **5yr misuse probability** — the auditor's qualitative-to-quantitative estimate of
  ...
  any user of this wallet) at some point within 5 years of the audit date, _if left
  unremediated_. Expressed as a band + rough % for comparability across audits:
...
| AW-2026-005 | Self-originated payments trust configured node's genesis data with no cross-check                                                                                                                                                                                                                                        | High              | Low (~5%, post-mitigation)                                          | Mitigated | `store/algod.ts`, `pages/Pay.vue`                                                                                                                     | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04) — scope narrowed: `env === "custom"` now skips the genesis cross-check entirely (commit `15999bf`)                  |
...
| AW-2026-010 | Custom algod/indexer endpoints fully user-editable, no validation/warning                                                                                                                                                                                                                                                | Medium            | Low (~10%, raised — now also feeds pre-sign simulation AW-2026-039) | Open      | `store/config.ts`, `pages/Settings.vue`                                                                                                               | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
| AW-2026-011 | Auto-selected public node/indexer list fetched unauthenticated, unpinned (now also feeds the AW-2026-005 genesis cross-check and AW-2026-039 simulation)                                                                                                                                                                 | Medium            | Low (~10%, raised)                                                  | Open      | `store/publicData.ts`, `store/config.ts`, `store/algod.ts`                                                                                            | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
| AW-2026-012 | 5-min session timeout exists and auto-logs-out, but "Continue Session" needs no password re-entry (description corrected 2026-07-10 — prior wording overstated "no timeout")                                                                                                                                             | Medium            | Low (~10%)                                                          | Open      | `components/Footer.vue`, `store/wallet.ts` (`prolong`/`logout`)                                                                                       | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
...
| AW-2026-015 | No Content-Security-Policy anywhere in the deployment stack                                                                                                                                                                                                                                                              | Low–Medium        | Low (~8%)                                                           | Open      | `index.html`, `docker/default.conf` (X-Frame-Options only), K8s ingress, no vercel.json                                                               | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
| AW-2026-016 | `approveSession` grants all networks regardless of DApp's requested namespaces                                                                                                                                                                                                                                           | Low               | Very Low (<2%)                                                      | Open      | `store/wc.ts`, `store/wcClient.ts`                                                                                                                    | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
| AW-2026-017 | WC v1 path hardcodes mainnet chainId 4160 regardless of active network                                                                                                                                                                                                                                                   | Low               | Very Low (<2%)                                                      | Open      | `shared/wc.ts:236`                                                                                                                                    | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
...
| AW-2026-021 | ARC-14 auth token lacks explicit endpoint/audience/timestamp binding                                                                                                                                                                                                                                                     | Medium            | Low (~8%)                                                           | Open      | `store/arc14.ts`, `scripts/encoding/arc14.ts`, `pages/Arc14.vue`                                                                                      | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04) — unchanged; `arc14.ts` byte-identical since `4cb0443`    |
| AW-2026-022 | Production deploy workflow has no build/test gate of its own                                                                                                                                                                                                                                                             | Medium            | Low (~5%)                                                           | Open      | `.github/workflows/awallet-main.yml`                                                                                                                  | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04) — unchanged; `.github/workflows/` byte-identical since `4cb0443`                           |
...
| AW-2026-024 | Legacy WalletConnect v1 client still a direct dependency (still source of high `pnpm audit` advisories via `ws`/`bn.js`)                                                                                                                                                                                                 | Low               | Low (~5%)                                                           | Open      | `package.json`, `shared/wc.ts`                                                                                                                        | `2026-07-09-4f915d4.md` @ `4f915d4` (2026-07-09)          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
...
| AW-2026-026 | In-memory session password wrapped with legacy CryptoJS keyed from localStorage (obfuscation only); dead `rs2` key                                                                                                                                                                                                       | Low               | Very Low (<2%)                                                      | Open      | `store/wallet.ts`, localStorage `rs1`/`rs2`                                                                                                           | `2026-07-09-ebe2059-fable-5.md` @ `ebe2059` (2026-07-09)  | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
...
| AW-2026-028 | Known CVEs in transitive deps (mostly via WC v1 chain) + unused `page` package; `pnpm audit --prod` at 4cb0443: 5 high / 3 moderate / 2 low                                                                                                                                                                              | Low               | Low (~3%)                                                           | Open      | `package.json`, `pnpm-lock.yaml`                                                                                                                      | `2026-07-09-ebe2059-fable-5.md` @ `ebe2059` (2026-07-09)  | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)                                                                                                  |
...
| AW-2026-037 | Redesigned `/faq` renders locale-file answer strings (with intentional embedded `<a>` HTML) through `v-html` — all 10 `src/locales/*.json` files join the XSS trust boundary; translation PRs are a realistic low-scrutiny vector; no live payload today (all anchors hardcoded trusted domains + `noopener noreferrer`) | Medium            | Low (~5%)                                                           | Closed    | `pages/FAQ.vue`, `src/locales/*.json` (`faq.categories.*.a*`)                                                                                         | `2026-07-16-6f2b077-fable-5.md` @ `6f2b077` (2026-07-16)  | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) — verified Closed: `<i18n-t>` + hardcoded slot URLs; no answer `v-html`                          |
| AW-2026-038 | WalletConnect client no longer auto-initializes (commit `9471074` removed `App.vue` bootstrap): approved-session sign requests silently unreceived until user clicks "Init WC" on `/account/connect`                                                                                                                     | Low               | Very Low (<2%)                                                      | Closed    | `App.vue` (removal retained), `pages/Connect.vue` init button, `CLAUDE.md` intentional-init policy                                                    | `2026-07-16-6f2b077-fable-5.md` @ `6f2b077` (2026-07-16)  | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) — Closed as intentional design (not restored auto-init); residual UX: show "not listening" state |
| AW-2026-039 | Pre-sign algod simulation UI can over-assert "actual" outcome; results fully trusted from configured node (compounds 010/011); unsigned intent always sent to node                                                                                                                                                       | Medium            | Low (~12%, reduced post-mitigation)                                 | Mitigated | `store/algod.ts` (`simulateTransactionGroups`), `components/TransactionGroupSimulation.vue`, `components/SwapRouteDiagram.vue`, `ConnectRequestsTable.vue`, `SignAll.vue`, swap sim copy | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04) — fix pass now committed and re-verified; residual risk **raised** by AW-2026-045 (preview ≠ signed bytes on Biatec path)                        |
| AW-2026-040 | Hardcoded shared Deflex API key in client source used for all default swap quotes                                                                                                                                                                                                                                        | Low               | Low (~8%)                                                           | Mitigated | `scripts/aggregators/deflex.ts`                                                                                                                       | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04) — fix pass now committed and re-verified (`deflex.ts` L5-L9); key still not rotated, still sent in query string     |
| AW-2026-041 | ARC-56 registry JSON fetched without integrity pin/signature (display-metadata poisoning only)                                                                                                                                                                                                                           | Low               | Very Low (~3%)                                                      | Mitigated | `scripts/arc56/registry.ts`, `scripts/arc56/decode.ts`, `Arc56CallDetails.vue`                                                                        | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04) — fix pass now committed and re-verified (`Arc56CallDetails.vue` L333/L336, keys in all 10 locales); no integrity pin yet            |
| AW-2026-042 | Residual reverse-tabnabbing: some `target="_blank"` links still lack `rel="noopener noreferrer"` (Login/NewWallet translate wiki, ScheduledPayments xGov)                                                                                                                                                                | Low               | Very Low (~2%)                                                      | Closed    | `components/Login.vue`, `components/NewWallet.vue`, `pages/Account/ScheduledPayments.vue`, `pages/Donation.vue`, `pages/PaymentGateway.vue`           | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04) — fix pass now committed; repo-wide grep re-run at HEAD confirms all 20 remote `target="_blank"` anchors carry `rel="noopener noreferrer"`                              |
| AW-2026-043 | DEX aggregator transactions are shape-validated before raw-key signing, but ordinary payments/asset transfers remain unbounded by the approved amount, receiver, or net economic effect                                                                                                                    | Critical          | Low (~8%, post-mitigation)                                          | Mitigated | `scripts/aggregators/validate.ts`, `scripts/aggregators/{biatec,folks,deflex}.ts`                                                                         | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | `2026-08-22-071d4f6-github-copilot.md` @ `071d4f6` (2026-08-22) — close/rekey/foreign sender blocked; ordinary-transfer drain remains                      |
| AW-2026-044 | ARC-60 domain is cross-checked against WalletConnect peer metadata, but peer metadata is DApp-supplied and request `verifyContext` is ignored                                                                                                                                                              | High              | Medium (~15%, post-mitigation)                                      | Mitigated | `scripts/encoding/arc60.ts`, `store/wc.ts`, `store/signer.ts`, `components/ConnectSignDataRequestsTable.vue`                                             | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | `2026-08-22-071d4f6-github-copilot.md` @ `071d4f6` (2026-08-22) — metadata mismatch blocked, malicious initial metadata still accepted                    |
| AW-2026-045 | Biatec swap `execute()` still re-fetches a route different from the preview; a slippage minimum is enforced against the router's own claimed output rather than decoded/simulated execute-time effects                                                                                                      | Medium            | Low (~8%, post-mitigation)                                          | Mitigated | `scripts/aggregators/biatec.ts`, `composables/useSwap.ts`                                                                                                | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | `2026-08-22-071d4f6-github-copilot.md` @ `071d4f6` (2026-08-22) — minimum added, preview-to-signed-bytes binding remains absent                            |
| AW-2026-046 | ARC-60 signing not scoped to the WalletConnect session's approved accounts — a session for account A can request a signature from account B                                                                                                                                                               | Low               | Very Low (<2%, after fix)                                           | Closed    | `store/signer.ts`, `store/wc.ts`                                                                                                                        | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | `2026-08-22-071d4f6-github-copilot.md` @ `071d4f6` (2026-08-22) — approved session accounts enforced at signing choke point                               |
| AW-2026-047 | ARC-60 digest carries no additional protocol domain-separation tag                                                                                                                                                                                                                                         | Informational     | Very Low (<2%)                                                      | Closed    | `scripts/encoding/arc60.ts`                                                                                                                              | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | `2026-08-22-071d4f6-github-copilot.md` @ `071d4f6` (2026-08-22) — closed as non-defect; implementation matches ARC-60's mandated digest                    |
| AW-2026-048 | ARC-60 AUTH accepts opaque/non-JSON data and permits signing when only base64 is shown; authenticator data and supplied HD path are not fully validated/displayed                                                                                                                                          | Medium            | Medium (~12%)                                                       | Open      | `scripts/encoding/arc60.ts`, `store/wc.ts`, `components/ConnectSignDataRequestsTable.vue`                                                               | `2026-08-22-071d4f6-github-copilot.md` @ `071d4f6` (2026-08-22) | same                                                                                                                                                  |
...
rather than silently excluded, since they are the dominant _real-world_ cause of
...
not fixable by a code change, tracked so the app's _UI-level_ mitigations (warning
...
- **AW-2026-031 (phishing of the wallet's own identity — fake site, fake app,
  ...
  Note for future audits: this is _distinct_ from AW-2026-008 (in-scope — a
  malicious _DApp_ impersonating a trusted DApp _to_ AWallet), which is a code
...
**2026-08-22 — audit `audits/reports/2026-08-22-071d4f6-github-copilot.md` @ `071d4f6`**
(covers `7564250..071d4f6`, 28 commits: DEX/ARC-60 remediation, Falcon-1024
accounts, usage-based fees, Biatec Scan/explorer integration, WalletConnect
lifecycle changes, and deployment updates):

- **AW-2026-048 (New, Medium):** ARC-60 AUTH decoding accepts arbitrary
  base64 bytes without requiring the JSON object mandated by ARC-60. The UI
  enables signing when it can show only opaque base64, and does not show the
  authenticator data/hash derivation. Optional `hdPath` is accepted but not
  validated or displayed. A malicious DApp can obtain a signature over content
  the user cannot meaningfully review.
- **AW-2026-043 (Mitigated, not Closed):** commit `0b3947e` correctly rejects
  foreign senders, rekey, ALGO close, and asset close before all three
  aggregator signing calls. The validator does not constrain ordinary payment
  or asset-transfer receiver/amount, fees, application calls, or net effects.
  A compromised API can still return an ordinary transfer of the user's
  spendable balance that passes validation and is signed with the raw key.
- **AW-2026-044 (Mitigated, not Closed):** ARC-60 now compares the requested
  domain with `session.peer.metadata.url` and shows that peer in the UI. Peer
  metadata is DApp-supplied, however, so a malicious DApp can spoof both values
  at session creation. WalletConnect supplies `verifyContext` on each
  `session_request`, but the current handler ignores it.
- **AW-2026-045 (Mitigated, not Closed):** Biatec's second route request now
  includes the slippage-adjusted minimum and checks the returned
  `outputAmount`. Both that amount and the signed transactions come from the
  same API response; the execute-time group is still neither re-simulated nor
  re-confirmed and is not bound to the previewed bytes.
- **AW-2026-046 (Closed):** approved addresses are extracted from the request's
  active WalletConnect session and enforced inside `signer/signArc60Data`
  before signing.
- **AW-2026-047 (Closed as non-defect):** the current ARC-60 draft explicitly
  mandates `EdDSA(SHA256(data) + SHA256(authenticatorData))`; the implementation
  is conformant and adding a private prefix would break interoperability.
- **Falcon-1024 review:** no new finding. Mnemonic generation uses Web Crypto,
  derivation is scheme-domain-separated, key material is covered by encrypted
  wallet persistence, export is password-gated/redacted, signing emits and
  verifies the SDK `pqsig` envelope over `bytesToSign()`, and fee adjustment has
  a 0.1 ALGO cap. No live network Falcon transaction was available for E2E
  confirmation.
- **Dependencies:** `pnpm audit --prod` reports 18 advisories (0 critical, 13
  high, 3 moderate, 2 low), up from 15. New `falcon-1024@0.2.0` has no install
  scripts and no reported advisory. WalletConnect v1 remains the highest-value
  dependency removal.
- **Verification:** `pnpm run test:unit` (17/17), `pnpm run check-locales`, and
  `pnpm run build` all pass. Cypress/browser E2E was not run; no live DApp,
  funded swap, or Falcon-enabled chain fixture was available.

**2026-08-04 — audit `audits/reports/2026-08-04-7564250-fable-5.md` @ `7564250`**
(covers `4cb0443..7564250`, 21 commits: ARC-60 `algo_signData` support, DEX
aggregator rework incl. Biatec combined-split routing and the opt-in stage
router, custom-network genesis fix, session-timeout UX):

- **AW-2026-043 (New, Critical):** all three DEX aggregators
  (`biatec.ts`/`folks.ts`/`deflex.ts`) take transactions returned by a remote
  HTTP API, decode them, and sign them with the account's **raw `sk`** with no
  validation of any field and no display to the user. A malicious or
  compromised aggregator API can return a transaction with `closeRemainderTo`,
  `assetCloseTo`, or `rekeyTo` set and the wallet signs and submits it
  silently — bypassing the entire reviewed-signing pipeline the AW-2026-001
  remediation built. This is **pre-existing code** that earlier audits did not
  trace, not a regression introduced this cycle. Highest-value fix: reject any
  aggregator-returned group containing those three fields or a foreign
  `sender`, before signing.
- **AW-2026-044 (New, High):** the new ARC-60 domain-binding check is
  self-referential. `validateAuthenticatorDataDomain` compares
  `authenticatorData[0..32]` against `SHA-256(domain)`, but **both** values
  arrive inside the same DApp-controlled WalletConnect request and are never
  compared to the real session peer (`session.peer.metadata.url`) or
  `verifyContext`. A malicious DApp can therefore obtain a valid AUTH
  signature binding any domain it names — the exact attack the function's own
  source comment claims to prevent. `wc.ts` has no `verifyContext` handling on
  the `session_request` path at all.
- **AW-2026-045 (New, Medium):** Biatec's `execute()` issues a **second**
  `postApiV1RouterRouteTxs` call and signs *that* response, while the
  simulation preview the user reviewed was computed from the `getQuote()`
  response. The AW-2026-039 preview therefore does not describe the bytes
  actually signed on this path; a dishonest router can return a benign route
  to the simulated call and a hostile one to the executed call.
- **AW-2026-046 (New, Low):** ARC-60 signing resolves the DApp-supplied
  `signer` through `ensureAccount` (whole wallet), not the session's approved
  accounts — same shape as the open AW-2026-016.
- **AW-2026-047 (New, Informational, needs verification):** the ARC-60 digest
  has no domain-separation tag and the account ed25519 key now signs two
  payload formats. No practical risk today (preimage resistance); flagged for
  confirmation against the final ARC-60 spec.
- **Prior fix pass now committed and independently re-verified:** AW-2026-039,
  -040, -041, -042 were recorded as "uncommitted" by the previous registry
  update; all four are on `master` at HEAD and confirmed in source. AW-2026-042
  stays Closed (the one bare `target="_blank"` remaining, `Settings.vue` L272,
  is a `data:` download link with no remote origin). AW-2026-039's residual
  risk is **raised**, not lowered, by AW-2026-045.
- **AW-2026-005 (Mitigated, scope narrowed deliberately):** commit `15999bf`
  makes `assertParamsMatchNetwork` and `Sign.vue`'s `fatal` computed return
  early when `env === "custom"`. Correct fix for a real bug ("custom" is a UI
  placeholder, not a genesis id), but custom-endpoint users now get no genesis
  cross-check at all. Residual exposure already tracked by AW-2026-010.
  Recorded so this is not later mistaken for a regression.
- **AW-2026-012 (Open, improved not closed):** `Footer.vue` gained a live
  countdown and a "Log out now" button, plus correct cs/sk/ru plural rules in
  `i18n.ts`. "Continue Session" still requires no password re-entry, which is
  the substance of the row.
- **No prior row regressed.** `store/{publicData,wallet,arc14}.ts`,
  `shared/wc.ts`, `index.html`, `docker/`, `.github/` are byte-identical to
  `4cb0443`, so AW-2026-010, -011, -015, -016, -017, -021, -022, -024, -026
  carry forward unchanged.
- **Dependencies:** `pnpm audit --prod` → 15 advisories (0 critical, 9 high, 4
  moderate, 2 low), up from 10 — advisory-database growth and new transitive
  paths, not new direct risk. New direct dep `tweetnacl@^1.0.3` (ARC-60
  signing) is clean. Noted under AW-2026-028: `@stablelib/ed25519` signature
  malleability is the only crypto-primitive advisory in the set; it arrives via
  the WalletConnect chain, not `algosdk`, so it does not affect transaction or
  ARC-60 signing.
- **Verification:** `pnpm run build` (vue-tsc + vite + PWA) and `pnpm run
check-locales` both clean at HEAD — AW-2026-035 not regressed, locale parity
  holds. Cypress not run (documented sandbox limitation); no live WC session,
  swap execution, or Ledger device test — the Critical and High findings are
  source-traced, not demonstrated against a running deployment.

**2026-07-30 — audit `audits/reports/2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443`**
(covers `6f2b077..4cb0443`: simulation-before-sign, ARC-56, ARC-14 UX, genesis
CAIP-10 fix, swap route sim, CI/CD/K8s):

- **AW-2026-037 (Closed, independently re-verified):** FAQ answers use
  `<i18n-t>` with component-owned link URLs; locale HTML guard still in
  `check-locales`. Prior registry note about "uncommitted fix" is obsolete —
  fix is on `master`.
- **AW-2026-038 (Closed as intentional design, registry correction):** The
  prior registry claimed an uncommitted restore of `App.vue` `initWc()`.
  At `4cb0443` that bootstrap is **still absent**; `CLAUDE.md` documents
  deliberate non-init-on-refresh to avoid unexpected fraudulent sign
  requests. Not re-opened as a bug solely for missing auto-init. Product
  follow-up (optional): surface "WC not listening" when sessions exist but
  client is null.
- **AW-2026-005 (Mitigated, improved):** `assertParamsMatchNetwork` now
  compares genesis hash via base64url CAIP-10 alphabet (commits in the
  `3d1b90a` / network-switch signing window).
- **New Open:** AW-2026-039 (Medium simulation trust/copy), AW-2026-040
  (Low Deflex default API key), AW-2026-041 (Low ARC-56 registry integrity),
  AW-2026-042 (Low residual tabnabbing links).
- **Not raised:** Ledger `toByte()` vs HD `bytesToSign()` — Ledger app API
  expects msgpack (`INS_SIGN_MSGPACK`); difference is by device contract.

**2026-07-30 — fix pass following `audits/reports/2026-07-30-4cb0443-grok-4-5.md`**
(applied on top of `4cb0443`, uncommitted at time of this registry update; to be
independently re-verified by the next audit run):

- **AW-2026-042 (Closed):** added `rel="noopener noreferrer"` to the three
  flagged `target="_blank"` anchors (`Login.vue`, `NewWallet.vue`'s translate-
  wiki link, `ScheduledPayments.vue`'s xGov#90 link). While auditing, also
  upgraded the two remaining `rel="noreferrer"`-only links
  (`Donation.vue`'s allo.info link, `PaymentGateway.vue`'s "try it out"
  button) to the explicit `noopener noreferrer` pair the report recommended
  as the app-wide convention. A repo-wide `grep -r 'target="_blank"'`
  confirms every remaining occurrence now carries `rel="noopener noreferrer"`.
- **AW-2026-041 (Mitigated):** `Arc56CallDetails.vue` now always renders the
  raw 4-byte method selector (hex) and the SHA-256 program hash alongside any
  registry-sourced contract/method name, for every trust level where they're
  known — so a technical user can independently cross-check the fetched
  label against the actual on-chain bytecode instead of trusting the
  registry response outright. New locale keys `arc56.raw_selector` /
  `arc56.program_hash` added to all 10 locale files. Not Closed: the registry
  fetch itself (`scripts/arc56/registry.ts`) still has no integrity pin/
  signature — that remains a larger follow-up (a build-time checksum
  manifest or signed registry).
- **AW-2026-040 (Mitigated):** `scripts/aggregators/deflex.ts`'s
  `DEFAULT_DEFLEX_API_KEY` now carries a comment documenting it as an
  intentional public/shared fallback identifier, not a secret, matching the
  report's "treat default as anonymous/public in docs" recommendation. Not
  Closed: the key itself was not rotated (this repo has no ability to
  contact Deflex to do so) and quote requests still pass it in the query
  string rather than a header (unverified whether Deflex's API accepts a
  header instead — changing this blind risked breaking swap quotes).
- **AW-2026-039 (Mitigated):** softened simulation copy in both the `connect`
  (WC batch table / SignAll panel) and `swap` (route preview) locale
  namespaces across all 10 locale files — "Simulation succeeded" / "You
  would actually pay" became "The node reports no errors" / "The node
  reports you would pay", and both `simulation_disclaimer` strings now
  explicitly warn that the preview is reported by the configured node and
  not independently verified, and that a compromised/malicious node could
  show a misleading result. Added a new `connect.simulation_source` string
  and a small "Previewed against node: `<host>`" badge to both
  `TransactionGroupSimulation.vue` (WC/SignAll panel) and
  `SwapRouteDiagram.vue` (swap route panel), reading the host from
  `store.state.config.algod` so the user can see which node produced the
  preview without having to check Settings. Not Closed: simulation still
  runs exclusively against the user-configured algod client (the
  architectural trust-in-node issue this finding is fundamentally about,
  shared with AW-2026-010/011) — no "explicit run" gating or elevated
  unpinned-node warning was added.
- Verified via `pnpm run check-locales` (all 10 locales pass), `pnpm run
  check-typescript-errors-vue` (clean), `pnpm run lint` (no new
  errors/warnings), and `pnpm run build` (vue-tsc + vite + PWA precache,
  clean).
...
- **AW-2026-025 (Closed):** `changePassword` (`store/wallet.ts`) now commits
  ...
  _new_ password instead of the old one it had been left holding from the
