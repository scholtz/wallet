...
| Field                                  | Value                                           |
| -------------------------------------- | ----------------------------------------------- |
| Last updated by audit report           | `audits/reports/2026-08-04-7564250-fable-5.md`  |
| Last updated (audited commit)          | `75642504823382e71aa326ac87b94c46cbdc9d61`      |
| Last updated (commit date)             | `2026-08-04`                                    |
| Last updated (AWallet package version) | `2.0.0`                                         |
| Last updated by                        | `fable-5`                                       |
...
| AW-2026-043 | DEX aggregator swaps blind-sign server-supplied transactions with the raw private key — no validation of `closeRemainderTo`/`assetCloseTo`/`rekeyTo`/sender/amount, and the transactions are never shown to the user before signing                                                                       | Critical          | Medium (~15%)                                                       | Open      | `scripts/aggregators/biatec.ts` (`execute` L152-281), `scripts/aggregators/folks.ts` (L104-127), `scripts/aggregators/deflex.ts` (L109-169), `scripts/aggregators/types.ts` | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | same                                                                                                                                                       |
| AW-2026-044 | ARC-60 domain binding is self-referential: `domain` and `authenticatorData` both come from the DApp request and are only checked against each other, never against the real WalletConnect session peer / `verifyContext` origin                                                                            | High              | Medium (~20%)                                                       | Open      | `scripts/encoding/arc60.ts` (L81-102), `store/wc.ts` (L289-344, L678-710), `store/signer.ts` (L431-480), `components/ConnectSignDataRequestsTable.vue`      | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | same                                                                                                                                                       |
| AW-2026-045 | Biatec swap `execute()` re-fetches a fresh route and signs those transactions, not the ones simulated/displayed at quote time — the AW-2026-039 preview does not cover the signed bytes                                                                                                                   | Medium            | Low (~10%)                                                          | Open      | `scripts/aggregators/biatec.ts` (`getQuote` L93-150, `execute` L152-281), `composables/useSwap.ts` (`simulateAggregatorQuote`)                             | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | same                                                                                                                                                       |
| AW-2026-046 | ARC-60 signing not scoped to the WalletConnect session's approved accounts — a session for account A can request a signature from account B                                                                                                                                                               | Low               | Low (~5%)                                                           | Open      | `store/signer.ts` (`signArc60Data` L431-480, `ensureAccount` L104-116), `store/wc.ts` (`signSignDataItem` L678-710)                                        | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | same                                                                                                                                                       |
| AW-2026-047 | ARC-60 digest (concatenated SHA-256 of data and of authenticatorData) carries no protocol domain-separation tag; same ed25519 key now signs two payload formats. Needs verification against final ARC-60 spec                                                                                                    | Informational     | Very Low (<2%)                                                      | Open      | `scripts/encoding/arc60.ts` (L105-115, L154-156)                                                                                                          | `2026-08-04-7564250-fable-5.md` @ `7564250` (2026-08-04)  | same                                                                                                                                                       |
