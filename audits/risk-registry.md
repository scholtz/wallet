...
| AW-2026-039 | Pre-sign algod simulation UI can over-assert "actual" outcome; results fully trusted from configured node (compounds 010/011); unsigned intent always sent to node                                                                                                                                                       | Medium            | Low (~12%)                                                          | Open      | `store/algod.ts` (`simulateTransactionGroups`), `components/TransactionGroupSimulation.vue`, `ConnectRequestsTable.vue`, `SignAll.vue`, swap sim copy | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) | same                                                                                                                                                       |
| AW-2026-040 | Hardcoded shared Deflex API key in client source used for all default swap quotes                                                                                                                                                                                                                                        | Low               | Low (~8%)                                                           | Open      | `scripts/aggregators/deflex.ts`                                                                                                                       | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) | same                                                                                                                                                       |
| AW-2026-041 | ARC-56 registry JSON fetched without integrity pin/signature (display-metadata poisoning only)                                                                                                                                                                                                                           | Low               | Very Low (~3%)                                                      | Open      | `scripts/arc56/registry.ts`, `Arc56CallDetails.vue`                                                                                                   | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) | same                                                                                                                                                       |
| AW-2026-042 | Residual reverse-tabnabbing: some `target="_blank"` links still lack `rel="noopener noreferrer"` (Login/NewWallet translate wiki, ScheduledPayments xGov)                                                                                                                                                                | Low               | Very Low (~2%)                                                      | Open      | `components/Login.vue`, `components/NewWallet.vue`, `pages/Account/ScheduledPayments.vue`                                                             | `2026-07-30-4cb0443-grok-4-5.md` @ `4cb0443` (2026-07-30) | same                                                                                                                                                       |
